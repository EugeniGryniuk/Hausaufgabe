public class Type {
    public static void main(String[] args) {
        ...
        System.out.println("После рассширения из int в byte наше число стало: " + intVar2);
        System.out.println("После рассширения из double в float наше число стало: " + doubleVar2);
